...
namespace Commons.Extensions
{
    public static class NumberExtensions
    {
        ...
        {
            return ToPersianText((long)value);
        }
        public static string ToPersianText(this int? value)
        {
        ...
        public static string ToPersianText(this decimal? value, bool showZeroBeforeDot = true, int decimalPlaces = 2)
        {
        ...
        public static string ToPersianText(this decimal value, bool showZeroBeforeDot = true, int decimalPlaces = 2)
        {
            ...
            if (v2 != null)
            {
                ...
                long lv = System.Convert.ToInt64(v2);
                if (lv > 0)
                {
        ...
        private static string GetPersianText(string[] numbersText)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < numbersText.Length; i++)
                {
                    ...
                    int v = System.Convert.ToInt32(txt);
                    if (v == 0)
                    {
                        level--;
                        continue;
        ...
        private static string GetThreeDigitNumberPersianText(string value)
        {
            ...
            if (txt[1] == '1')
            {
                int v = System.Convert.ToInt32(txt.Substring(1));
                switch (v)
                {
                    case 10:
                        sb.Append("ده");
